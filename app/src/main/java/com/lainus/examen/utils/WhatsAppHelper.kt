package com.lainus.examen.utils
...
// Actualizar el ViewModel para usar WhatsAppHelper
// En PlansViewModel, modificar onPlanSelected:
/*
fun onPlanSelected(context: Context, plan: Plan) {
    WhatsAppHelper.openWhatsApp(context, plan)
}
*/